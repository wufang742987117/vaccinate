...
//			this.baseURL = FileUtils.path(ServletContextFactory.getServletContext().getContextPath() + Global.USERFILES_BASE_URL + principal + "/");
//			this.baseDir = FileUtils.path(Global.getUserfilesBaseDir() + Global.USERFILES_BASE_URL + principal + "/");
			this.baseURL = FileUtils.path(ServletContextFactory.getServletContext().getContextPath() + "/"+Global.USERFILES_BASE_URL);
