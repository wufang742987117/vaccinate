...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static List<String> splitToList(final String str, final char separatorChar) {
		return Splitter.on(separatorChar).trimResults().omitEmptyStrings().splitToList(str);
	}
	...
	public static List<String> splitToList(final String str, final String separatorChars) {
		return Splitter.on(separatorChars).trimResults().omitEmptyStrings().splitToList(str);
	}
