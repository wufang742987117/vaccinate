 ...
 * @version 2017-02-20
 */
public class BsManageStatistics extends DataEntity<BsManageStatistics> {
	...
	public BsManageStatistics() {
		super();
	}

	public BsManageStatistics(String id){
		super(id);
	}
	...
	@ExcelField(title="批次编号", align=1, sort=30)
