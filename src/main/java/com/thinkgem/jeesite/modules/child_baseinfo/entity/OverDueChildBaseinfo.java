 ...
 * @version 2017-02-06
 */
public class OverDueChildBaseinfo extends DataEntity<OverDueChildBaseinfo> {
	...
	/** 添加条件-把家庭地址分开获取，拼接 */
	/*private String province; // 家庭地址 省
	private String city; // 家庭地址 市
	private String area; // 家庭地址 区
	private String address; // 家庭的详细地址
*/	/** 添加条件-把户籍地址分开获取，拼接 */
	/*private String province1; // 户籍 省
	private String city1; // 户籍 市
	private String area1; // 户籍 区
*/
	...
	public OverDueChildBaseinfo() {
		super();
	}

	public OverDueChildBaseinfo(String id) {
		super(id);
	}
	...
	@ExcelField(align=2, title="儿童姓名", sort = 11 )
	...
	@ExcelField(align=2, title="性别", sort = 12, dictType="sex" )
	...
	@ExcelField(align = 2, title = "出生日期", sort = 13, fieldType = Date.class)
	...
	@ExcelField(align=2, title="母亲姓名", sort = 18)
	...
	@ExcelField(align = 2, title = "接种单位名称", sort = 14)
	...
	@ExcelField(align=2, title="通讯地址", sort = 21)
	...
	@ExcelField(align = 2, title = "母亲电话", sort = 20)
	...
	@ExcelField(align=2, title="在册情况", sort = 16,dictType="situation")
	...
	@ExcelField(align=2, title="区域划分", sort = 15 )
	...
	@ExcelField(align=2, title="父亲姓名", sort = 17 )
	...
	@ExcelField(align=2, title="父亲电话", sort = 19 )
	...
	@ExcelField(align=2, title="应种疫苗", sort = 100 )
	...
	@ExcelField(align=2, title="应种剂次", sort = 101 )
	public String getNid() {
		if(StringUtils.isNotBlank(nid) && nid.length() >2){
			return nid.substring(2);
		}
		return nid;
	}
	...
	@ExcelField(align=2, title="应种日期", sort = 102 )
	...
	@ExcelField(align=2, title="备注", sort = 100 )
