...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<button type="button" class="actions-btn bs-select-all btn btn-multiple">' +
      this.options.selectAllText +
      '</button>' +
      '<button type="button" class="actions-btn bs-deselect-all btn btn-multiple">' +
      ...
      '<button type="button" class="btn btn-sm btn-multiple">' +
