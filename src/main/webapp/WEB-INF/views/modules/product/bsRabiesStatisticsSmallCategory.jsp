        ...
        $(document).ready(function() {
			$("#btnExport").click(function(){
				layer.confirm("确认要导出数据吗？", {
					...
					$("#searchForm").attr("action","${ctx}/rabiesvaccine/bsRabiesCheckin/exportSmallCategory");
					$("#searchForm").submit();
					layer.close(index);
...
<%-- 		<li><a href="${ctx}/product/bsManageProduct/repertorySum">库存统计</a></li> --%>
		...
		<li class="active"><a href="${ctx}/rabiesvaccine/bsRabiesCheckin/bsCheckinStatisticsSmallCategory">小类接种统计</a></li>
	...
	<div class="ibox">
		<div >
			<form:form id="searchForm" modelAttribute="bsRabiesStatistics" action="${ctx}/rabiesvaccine/bsRabiesCheckin/bsCheckinStatisticsSmallCategory" method="post" class="form-inline mt20">
					<div class = "col-xs-12">
