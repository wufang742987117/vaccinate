        ...
        $(document).ready(function() {
			$("#btnExport").click(function(){
				layer.confirm("确认要导出数据吗？", {
					...
					$("#searchForm").attr("action","${ctx}/rabiesvaccine/bsRabiesCheckin/exportBatch");
					$("#searchForm").submit();
					layer.close(index);
...
<%-- 		<li><a href="${ctx}/product/bsManageProduct/repertorySum">库存统计</a></li> --%>
		<li class="active"><a href="${ctx}/rabiesvaccine/bsRabiesCheckin/bsCheckinStatisticsBatch">批次接种统计</a></li>
	...
	<div class="ibox">
		<div >
			<form:form id="searchForm" modelAttribute="bsRabiesStatistics" action="${ctx}/rabiesvaccine/bsRabiesCheckin/bsCheckinStatisticsBatch" method="post" class="form-inline mt20">
					<div class = "col-xs-12">
			...
			<table id="contentTable" class="table table-striped table-bordered table-condensed">
				...
				<c:forEach items="${bsStatisticsList}" var="bsRabiesStatistics">
					<tr>
						<td>
							${bsRabiesStatistics.vaccname}
						</td>
						<td>
							${bsRabiesStatistics.batchno}
						</td>
						<td>
