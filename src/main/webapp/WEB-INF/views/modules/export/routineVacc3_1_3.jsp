...
<body>
	<form:form id="searchForm" action="${ctx}/export/export/routineVacc3_1_3" method="post">
		...
		<div class="input-group" >
			...
			<button id="exportBt"  style="margin-top:20px;"class="btn btn-primary" onclick="SaveAsFile('常规接种（3-1-3）')"  >导出</button>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<table id="exportTable" border="1" style="border:solid 1px black;border-collapse:collapse;">
		<thead>
			<tr class="title">
				<th style="text-align:center"class="title" colspan="30">${yearstr}&nbsp;年&nbsp;${monthstr}&nbsp;月&nbsp;<12月龄的国家免疫规划疫苗基础接种情况统计汇总报表（表3-1-3）
					<c:choose>
