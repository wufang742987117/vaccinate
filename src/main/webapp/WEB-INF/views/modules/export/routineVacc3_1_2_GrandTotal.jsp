...
<body>
	...
	<div class="ibox-content">
		<form:form id="searchForm" action="${ctx}/export/export/routineVacc3_1_2_GrandTotal" method="post">
			...
			<div class="input-group" >
				...
				<button id="exportBt"  style="margin-top:20px;"class="btn btn-primary" onclick="SaveAsFile('常规接种（3-1-2）累计')"  >导出</button>&nbsp;&nbsp;&nbsp;&nbsp;
				<button id="saveAsBtn"  style="margin-top:20px;"class="btn btn-primary" onclick="javascript:#"  >另存</button>&nbsp;&nbsp;&nbsp;&nbsp;
				<button id="printBtn" style="margin-top:20px;" class="btn btn-primary" onclick="window.print()">打印</button> &nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table id="exportTable" border="1" style="border:solid 1px black;border-collapse:collapse;width: 1000px;">
			<thead>
				<tr class="title">
					<th colspan="30">
						<p size="3" style="text-align:center;">${yearstr}&nbsp;年&nbsp;${monthstr}&nbsp;月&nbsp;所有儿童国家免疫规划疫苗基础预防接种情况统计汇总报表 累计（表3-1-2）
							<c:choose>
