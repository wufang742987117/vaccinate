...
<body>
	<form:form id="searchForm" action="${ctx}/export/export/routineVacc3_1_3_GrandTotal" method="post">
		...
		<div class="input-group" >
			...
			<button id="exportBt"  style="margin-top:20px;"class="btn btn-primary" onclick="SaveAsFile('常规接种（3-1-3）累计')"  >导出</button>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<table id="exportTable" border="1" style="border:solid 1px black;border-collapse:collapse;">
		<thead>
			<tr class="title">
				<th style="text-align:center"class="title" colspan="30">${yearstr}&nbsp;年&nbsp;${monthstr}&nbsp;月&nbsp;<12月龄国家免疫规划疫苗基础接种情况统计汇总报表 累计（表3-1-3）
					<c:choose>
		...
		<tbody>
			<tr>
				<td colspan="25" class="text-left">
					<font size="2">${sheng}&emsp;${shi}&emsp;${qu}&emsp;相南办&emsp;${off}</font><br>
			...
			<tr class="b">
				...
				<td rowspan=4>去年人口总数</td>
				<td rowspan=4>去年出生人数</td>
				<td colspan=12>基础免疫累计应种人数</td>
				<td colspan=13>基础免疫累计受种人数</td>
			</tr>
			<tr>
				<td rowspan=3>BCG</td>
			...
			<tr>  
				<td colspan="30" class="text-left">
					<font size="2"> ②应种和受种人数均包括＜12月龄内的儿童；</font>
				</td>
			</tr>
			<tr>  
				<td colspan="30" class="text-left">
