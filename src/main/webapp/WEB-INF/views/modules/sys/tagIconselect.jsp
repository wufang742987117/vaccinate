...
<head>
	...
	<style type="text/css">
		.fontawesome-icon-list div {float:left;width:30%;line-height:25px;margin:2px 5px;cursor:pointer;}
		.active {background-color: #1d9d74;color: #fff;text-decoration: none;}
	</style>
