...
<div id="search" class="form-inline hide" style="padding:10px 0 0 13px;">
	<div class="form-group">
		<div class="input-group">
			<span class="input-group-addon gray-bg text-right">关键字：</span>
			<input type="text" class="form-control empty" id="key" name="key" maxlength="50" style="width:110px;">
			<button class="btn" id="btn" class="btn btn-primary" onclick="searchNode()">搜索</button>
		</div>
	</div>
</div>
