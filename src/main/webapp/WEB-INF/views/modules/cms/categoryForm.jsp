		...
		<div class="ibox-content">
			<form:form id="inputForm" modelAttribute="category" action="${ctx}/cms/category/save" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<form:input path="href" htmlEscape="false" cssClass="form-control" maxlength="200"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<form:input path="target" htmlEscape="false" cssClass="form-control" maxlength="200"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<form:radiobuttons element="label class='checkbox-inline i-checks'" path="inMenu" items="${fns:getDictList('show_hide')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<form:radiobuttons element="label class='checkbox-inline i-checks'" path="inList" items="${fns:getDictList('show_hide')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<form:radiobuttons element="label class='checkbox-inline i-checks'" path="showModes" items="${fns:getDictList('cms_show_modes')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/><%--
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<form:radiobuttons element="label class='checkbox-inline i-checks'" path="allowComment" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">是否需要审核:</label>
					<div class="col-sm-2">
						<form:radiobuttons element="label class='checkbox-inline i-checks'" path="isAudit" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</div>
				</div>
				<div class="form-group">
