			...
			<form:form id="searchForm" modelAttribute="site" action="${ctx}/cms/site/" method="post" class="form-inline">
				...
				<div class="form-group">
					<div class="input-group">
						...
						<form:radiobuttons onclick="$('#searchForm').submit();" element="label class='checkbox-inline i-checks'" path="delFlag" items="${fns:getDictList('del_flag')}" itemLabel="label" itemValue="value" htmlEscape="false" />
					</div>
				</div>
				<div class="form-group">
